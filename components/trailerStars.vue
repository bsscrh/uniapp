<template name="trailerStars">
	<view class="movie-score-wapper">
		<image v-for="(yellow,index) in yelloScore" src="../../static/icos/star-yellow.png" class="star-ico" :key="index"></image>

		<image v-for="(gray,index) in grayScore" src="../../static/icos/star-gray.png" class="star-ico" :key="index+5"></image>
