...
var x=['./components/hello.wxml','./components/trailerStars.wxml','./pages/index/index.wxml','./pages/me/me.wxml','./pages/search/search.wxml'];d_[x[0]]={}
...
var t1=_mz(z,'swiper',['autoplay',1,'class',1,'indicatorDots',2],[],e,s,gg)
...
var c8=_mz(z,'image',['class',10,'src',1],[],e,s,gg)
_(f7,c8)
var h9=_n('view')
...
_(o6,f7)
_(aZ,o6)
var cAB=_mz(z,'scroll-view',['class',14,'scrollX',1],[],e,s,gg)
var oBB=_v()
_(cAB,oBB)
var lCB=function(tEB,aDB,eFB,gg){
var oHB=_n('view')
_rz(z,oHB,'class',19,tEB,aDB,gg)
var xIB=_n('view')
_rz(z,xIB,'class',20,tEB,aDB,gg)
var oJB=_mz(z,'image',['class',21,'src',1],[],tEB,aDB,gg)
_(xIB,oJB)
var fKB=_n('view')
_rz(z,fKB,'class',23,tEB,aDB,gg)
var cLB=_oz(z,24,tEB,aDB,gg)
_(fKB,cLB)
_(xIB,fKB)
var hMB=_mz(z,'trailer-stars',['bind:__l',25,'innerScore',1,'showNum',2,'vueId',3],[],tEB,aDB,gg)
_(xIB,hMB)
_(oHB,xIB)
_(eFB,oHB)
return eFB
...
oBB.wxXCkey=4
_2z(z,18,lCB,e,s,gg,oBB,'superhero','__i0__','')
_(aZ,cAB)
var oNB=_n('view')
_rz(z,oNB,'class',29,e,s,gg)
var cOB=_n('view')
_rz(z,cOB,'class',30,e,s,gg)
var oPB=_mz(z,'image',['class',31,'src',1],[],e,s,gg)
_(cOB,oPB)
var lQB=_n('view')
...
var cZB=_mz(z,'video',['controls',-1,'bindplay',39,'class',1,'data-event-opts',2,'data-playingindex',3,'id',4,'poster',5,'src',6],[],xWB,oVB,gg)
_(oXB,cZB)
return oXB
}
eTB.wxXCkey=2
_2z(z,38,bUB,e,s,gg,eTB,'trailer','index','')
_(aZ,tSB)
var h1B=_n('view')
_rz(z,h1B,'class',46,e,s,gg)
var o2B=_n('view')
_rz(z,o2B,'class',47,e,s,gg)
var c3B=_mz(z,'image',['class',48,'src',1],[],e,s,gg)
_(o2B,c3B)
var o4B=_n('view')
_rz(z,o4B,'class',50,e,s,gg)
var l5B=_oz(z,51,e,s,gg)
_(o4B,l5B)
_(o2B,o4B)
_(h1B,o2B)
_(aZ,h1B)
...
var fCC=_n('view')
_rz(z,fCC,'class',56,o0B,b9B,gg)
var cDC=_mz(z,'navigator',['openType',57,'url',1],[],o0B,b9B,gg)
var hEC=_mz(z,'image',['class',59,'src',1],[],o0B,b9B,gg)
_(cDC,hEC)
_(fCC,cDC)
var oFC=_n('view')
_rz(z,oFC,'class',61,o0B,b9B,gg)
var cGC=_n('view')
_rz(z,cGC,'class',62,o0B,b9B,gg)
var oHC=_oz(z,63,o0B,b9B,gg)
_(cGC,oHC)
_(oFC,cGC)
var lIC=_mz(z,'trailer-stars',['bind:__l',64,'innerScore',1,'showNum',2,'vueId',3],[],o0B,b9B,gg)
_(oFC,lIC)
var aJC=_n('view')
_rz(z,aJC,'class',68,o0B,b9B,gg)
var tKC=_oz(z,69,o0B,b9B,gg)
_(aJC,tKC)
_(oFC,aJC)
var eLC=_n('view')
_rz(z,eLC,'class',70,o0B,b9B,gg)
var bMC=_oz(z,71,o0B,b9B,gg)
_(eLC,bMC)
_(oFC,eLC)
_(fCC,oFC)
var oNC=_mz(z,'view',['bindtap',72,'class',1,'data-event-opts',2,'data-gIndex',3],[],o0B,b9B,gg)
var xOC=_mz(z,'image',['class',76,'src',1],[],o0B,b9B,gg)
_(oNC,xOC)
var oPC=_n('view')
_rz(z,oPC,'class',78,o0B,b9B,gg)
var fQC=_oz(z,79,o0B,b9B,gg)
_(oPC,fQC)
_(oNC,oPC)
var cRC=_mz(z,'view',['animation',80,'class',1],[],o0B,b9B,gg)
var hSC=_oz(z,82,o0B,b9B,gg)
_(cRC,hSC)
_(oNC,cRC)
_(fCC,oNC)
_(xAC,fCC)
...
t7B.wxXCkey=4
_2z(z,55,e8B,e,s,gg,t7B,'guess','gIndex','')
_(aZ,a6B)
_(r,aZ)
return r
}
...
__wxAppCode__['components/hello.wxss']=setCssToHead([".",[1],"txt { color: green; }\n",],undefined,{path:"./components/hello.wxss"});    
__wxAppCode__['components/hello.wxml']=$gwx('./components/hello.wxml');
